...
export type AstronomyStore<TState> = Store<TState> & {
...
export type SelectorsClosure<
        ...
        TExternalDependencies
    > = (
    externalDependencies: TExternalDependencies ) => TSelectors
...
export type DimensionParameters<
    ...
    store?: AstronomyStore<TDimensionDefinitions['state']>,
}